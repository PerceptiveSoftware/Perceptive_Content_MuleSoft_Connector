...
package com.perceptivesoftware.mule.connector.client.model.forms;
...
public class Forms {
    ...
    @JsonProperty("forms")
    private List<FormInfo> forms = new ArrayList<FormInfo>();
    @JsonIgnore
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Forms) == false) {
            return false;
        }
        Forms rhs = ((Forms) other);
